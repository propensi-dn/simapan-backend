...
from .manager_views import (
    ManagerPendingLoansView,
    ManagerLoanDetailView,
    ManagerDashboardView,
    ManagerLoanStatusUpdateView,
    ManagerBulkApproveLoansView,
)
...
urlpatterns = [
    ...
    path('pending/bulk-approve/', ManagerBulkApproveLoansView.as_view(), name='manager-bulk-approve-loans'),
